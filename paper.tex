...
Visual odometers for AUVs \cite{Botelho2009} tend to use this pipeline and adapt every stage options (such us keypoint detector type and feature matching method) to they needs. Common feature detectors used for real-time visual odometry include Harris corners \cite{Harris1988} and FAST features \cite{Rosten2006}, which have a low computation cost and are robust against small viewpoint changes.

Several AUVs localization algorithms are based on mosaics or structured enviroments and therefore assumes prior knowledge of the area to explore \cite{Garcia2001} \cite{Gracias2003} \cite{Carreras2003}.
...
\begin{table}[!t]
  ...
  \label{tab:results_attr}
  \centering
  \begin{tabular}{|l|l|l|l|} \hline
    \textbf{Algorith} & \textbf{Translation} & \textbf{Rotation} & \textbf{Runtime}\\ \hline
    libviso2 & 0.00978\% & 0.001739 [deg/m] & TODO \\ \hline
    fovis    & 0.00601\% & 0.006311 [deg/m] & TODO \\ \hline
  \end{tabular} 
\end{table}
...
\begin{table}[!t]
  ...
  \begin{tabular}{|l|l|l|l|} \hline
    \textbf{Algorith} & \textbf{Translation} & \textbf{Rotation} & \textbf{Runtime}\\ \hline
    libviso2 & 0.00833\% & 0.007913 [deg/m] & TODO \\ \hline
    fovis    & 0.01049\% & 0.003122 [deg/m] & TODO \\ \hline
  \end{tabular} 
\end{table}
